...
public class AdminSignupController {
    ...
    @FXML private Button signupButton; // Add fx:id
    ...
    private void handleSignup() { // Removed throws IOException
        ...
        if (success) {
            signupMessage.setText("Admin signup request submitted! Your account will be reviewed for approval.");
            signupMessage.setStyle("-fx-text-fill: blue;"); // Use blue for pending status
    ...
    private void loadWelcomeScreen() throws IOException {
        Stage stage = (Stage) backButton.getScene().getWindow(); // Use backButton
